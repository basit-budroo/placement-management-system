...
{				?>	
										<tr>
                                            ...
                                            <td><?php echo htmlentities($result->dateof);?></td>
											<td>
											<?php 
											...
											$sql1="SELECT COUNT(user_id) as noofstudent FROM `apply_status` WHERE company_name = '$company_name' and applied = 1";
											...
											{	?>
												<a href="see-student.php?nm=<?php echo htmlentities($company_name);?>">
												<?php 
												echo htmlentities($result1->noofstudent)
												?>
												</a> 
											<?php
											}
